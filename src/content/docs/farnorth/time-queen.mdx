...
Upon fatal damage that would kill her, she will instead enter a state of invulnerability for **5** seconds, while also slowing all velocities nearby. During this period all weapons cooldown are always instantly reset, and she will be able to use her abilities in rapid succession. But after it ends, she will die instantly.
