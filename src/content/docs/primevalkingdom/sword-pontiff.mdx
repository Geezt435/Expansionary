...
A book that contains the knowledge of sword and decay, it is used to cast **Withering Sword**, which is a conjured phantom sword that flies towards the target slowly and deals decay damage over time. It is not known whether the book is his or not, but it is said that the book is a gift from the old ruler of the kingdom. For some reason you can't feel its presence, as if it is not there at all.
